...
class RestTests {
  ...
  runUnitTests () {
    return new Promise((resolve, reject) => {
      shell.cd(`${__dirname.toString()}/../uut/bch-api`)

      const execStr = `npm run test > ${__dirname.toString()}/../html/logs/bch-api/unit-test.txt`
  ...
  async runAbcIntegrationTests () {
    return new Promise((resolve, reject) => {
      shell.cd(`${__dirname.toString()}/../uut/bch-api`)
      shell.cp(`${__dirname.toString()}/../private/test-abc-infra.sh`, '.')

      const execStr = `./test-abc-infra.sh > ${__dirname.toString()}/../html/logs/bch-api/abc-integration-test.txt`
  ...
  async runBchnIntegrationTests () {
    return new Promise((resolve, reject) => {
      shell.cd(`${__dirname.toString()}/../uut/bch-api`)
      shell.cp(`${__dirname.toString()}/../private/test-bchn-infra.sh`, '.')

      const execStr = `./test-bchn-infra.sh > ${__dirname.toString()}/../html/logs/bch-api/bchn-integration-test.txt`
