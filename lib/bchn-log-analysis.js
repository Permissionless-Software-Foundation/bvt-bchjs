...
class AnalyizeLogs {
  ...
  async endpointReport() {
    ...
    shell.exec(
      `echo " " >> ${__dirname}/../html/logs/fullstack-analytics/bchn-analytics.txt`
    );
    shell.exec(
      `echo "Endpoint Report:" >> ${__dirname}/../html/logs/fullstack-analytics/bchn-analytics.txt`
    );
    shell.exec(
      `./bin/run endpoint-report >> ${__dirname}/../html/logs/fullstack-analytics/bchn-analytics.txt`
    );
  ...
  async errorReport() {
    ...
    shell.exec(
      `./bin/run error-report >> ${__dirname}/../html/logs/fullstack-analytics/bchn-analytics.txt`
    );
  }
}
