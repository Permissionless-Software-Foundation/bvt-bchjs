...
const SERVERS = [
  { serverUrl: "http://192.168.0.36:3000/v3/", testnet: false }, // BCHN
  { serverUrl: "http://192.168.0.38:3000/v3/", testnet: false }, // ABC
  { serverUrl: "http://192.168.0.44:4000/v3/", testnet: true } // testnet3
];
...
class LivenessTests {
  ...
  async livenessFullNode(bchjs) {
    try {
      ...
      console.log(`Error in liveness.js/livenessFullNode(): `, err.message);
    }
  }
  ...
  async livenessElectrumx(bchjs, addr) {
    try {
      ...
      console.error(`Error in liveness.js/livenessElectrumx(): `, err.message);
    }
  }
  ...
  async livenessSlpdb(bchjs, addr) {
    try {
      ...
      console.error(`Error in liveness.js/livenessSlpdb(): `, err.message);
    }
  }
  ...
  async livenessBlockbook(bchjs, addr) {
    try {
      ...
      console.log(`Error in liveness.js/mainnetBlockbook(): `, err.message);
    }
  }
}
