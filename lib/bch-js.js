  ...
  async runBchnIntegrationTests() {
    return new Promise((resolve, reject) => {
      try {
        ...
        const execStr = `npm run test:integration:bchn > ${__dirname}/../html/logs/bitbox/integration-test.txt`;
  ...
  async runAbcIntegrationTests() {
    return new Promise((resolve, reject) => {
      try {
        ...
        // const execStr = `BCHJSTOKEN=${config.apiToken} npm run test:integration > ${__dirname}/../html/logs/bitbox/integration-test.txt`;
        const execStr = `npm run test:integration:abc > ${__dirname}/../html/logs/bitbox/free-test.txt`;
  ...
  async runTestnetIntegrationTests() {
    return new Promise((resolve, reject) => {
      try {
        ...
        const execStr = `BCHJSTOKEN=${process.env.BCHJSTOKEN} RESTURL=https://testnet3.fullstack.cash/v3/ npm run test:integration:testnet > ${__dirname}/../html/logs/bitbox/testnet-test.txt`;
