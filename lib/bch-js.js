  ...
  async runTestnetIntegrationTests() {
    return new Promise((resolve, reject) => {
      try {
        ...
        const execStr = `BCHJSTOKEN=${process.env.BCHJSTOKEN} RESTURL=https://testnet3.fullstack.cash/v5/ npm run test:integration:testnet > ${__dirname}/../html/logs/bch-js/testnet3-integration-test.txt`;
